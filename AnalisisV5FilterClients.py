...
def main():
    try:
        ...
        with _time_block("Creación y guardado de rollup_canibalizacion.csv"):
            ...
            rollup_df = rollup_df.loc[rollup_df["hist_ediciones_distintas"] >= 1]
            logger.info(_df_stats(rollup_df, "rollup_df"))
            out_rollup = r'/home/sam.salinas/PythonProjects/H3Canibalization/rollup_canibalizacionFilterClients.csv'
